...
// Implements the included_root algorithm from draft-bryce-cose-receipts-mmr-profile.
...
function includedRoot(uint256 i, bytes32 nodeHash, bytes32[] calldata proof) pure returns (bytes32 root) {
